...
class CocoDataset(utils.Dataset):
    def load_coco(self,
        ...
        year: What dataset year to load (2014, 2017) as a string, not an
         integer
        class_ids: If provided, only loads images that have the given classes.
        class_map: TODO: Not implemented yet. Supports maping classes from
            different datasets to the same class ID.
        return_coco: If True, returns the COCO object.
        auto_download: Automatically download and unzip MS-COCO images and
         annotations
        """
    ...
    def auto_download(self, dataDir, dataType, dataYear):
        ...
        dataYear: What dataset year to load (2014, 2017) as a string, not an
         integer
        Note:
        ...
        if dataType == "minival" or dataType == "valminusminival":
            ...
            imgURL = "http://images.cocodataset.org/zips/{}{}.zip".format(
                dataType, dataYear)
        # print("Image paths:"); print(imgDir); print(imgZipFile);
        #  print(imgURL)
        ...
        if dataType == "minival":
            ...
            annURL = ("https://dl.dropboxusercontent.com/s/" +
                      "o43o90bna78omob/instances_minival2014.json.zip?dl=0")
            unZipDir = annDir
            ...
            annURL = (
                ...
                "s3tw5zcg7395368/instances_valminusminival2014.json.zip?dl=0")
            unZipDir = annDir
        else:
            ...
            annFile = "{}/instances_{}{}.json".format(annDir, dataType,
                                                      dataYear)
            annURL = ("http://images.cocodataset.org/annotations/" +
                      "annotations_trainval{}.zip").format(dataYear)
            unZipDir = dataDir
